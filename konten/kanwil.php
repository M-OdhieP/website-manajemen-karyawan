...
<center><h4>Data Pegawai Kantor Wilayah Provinsi Lampung</h4></center>

<table id="example" class="table table-hover text-nowrap table-responsive table-striped table-bordered" style="width:100%">
        <thead>
            <tr>
...
$sql = "SELECT * FROM pegawai where kantor='KANTOR WILAYAH BPN PROVINSI LAMPUNG'";
