...
<center><h4>Data Pegawai Kantor Pertanahan Kab. Tulang Bawang Barat</h4></center>
...
$sql = "SELECT * FROM pegawai where kantor='KANTOR PERTANAHAN Kab. Tulang Bawang Barat'";
